...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2023 at 10:15 AM
...
(1, 'MERN Stacks', 'MERN Stack developers are primarily in charge of developing and designing front end web architecture and building interactive consumer data from multiple systems. They define code architecture decisions to support high-performance products.', '', 'Under Graduate', 0, 5, 'Pune', 'Internship', 8, '2023-11-02', 3, 8, 'Developer', 'Development', 'Any', 30, '2023-11-20', '- Adept with ReactJs or Angular.\r\n\r\n- Good to have knowledge of hooks.\r\n\r\n- Experience in NodeJS, PHP or Python with any of its respective framework.\r\n\r\n- Mastery of object-oriented JavaScript, TypeScript, ES6, HTML\r\n\r\n- Experience with state-management library such as Redux, Flux, or anything similar', 'React, mongodb, node, express, html, css, javascript', 'On-site', NULL, NULL),
(2, 'MEAN Stack', 'MEAN Stack', 'Nova Corporations', 'Graduate', 2, 4, 'Mars', 'Full Time', 10, '0000-00-00', 1000, 5000, 'Developer', 'Web Developer', 'Any', 3, '2023-11-09', 'Ability to make interactive web pages', 'MongoDB,ExpressJs,AngularJs,NodeJs', 'On Site', 'flower.png', NULL),
(3, 'Test', '<p>Test</p>', '1', 'Graduate', 1, 2, 'Pune', 'Full Time', 3, '0000-00-00', 10000, 50000, 'Developer', 'Consultancy', 'Any', 3, '2023-11-08', 'Test', 'MongoDB, ExpressJs, AngularJs, NodeJs ,React ', 'Remote', 'Swaraj.jpg', NULL),
(4, 'Test', '<p>Test</p>', '1', 'Under Graduate', 1, 2, 'Pune', 'Internship', 3, '0000-00-00', 10000, 50000, 'Developer', 'Development', 'Male', 3, '2023-11-08', '', 'MongoDB, ExpressJs, AngularJs, NodeJs ,React ', 'On-site', NULL, NULL);
