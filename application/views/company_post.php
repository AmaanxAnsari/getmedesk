...
<head>
	<!-- meta tag -->
	<meta charset="utf-8" />
	<title>GetMeDesk - Post Company</title>
	...
	<section class="job-post ptb-100">
		<div class="container" style="max-width: 1172px">
			<div class="card job-post-card">
				...
				<form action="<?php echo base_url('create_company') ?>" method="POST">
					<div class="row">
						...
						<div class="col-lg-6 col-md-6">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="glassdoor"
									placeholder="Paste Glassdoor URL" />
							</div>
						</div>
						...
						<div class="col-lg-4 col-md-4">
							<div class="form-group">
								...
								<input class="form-control" type="date" name="establishedin" />
							</div>
						</div>
						<div class="col-lg-4 col-md-4">
							<div class="form-group">
								<label>Employee Size</label>
								<input class="form-control" type="number" name="employee_size" />
							</div>
						</div>
						<div class="col-lg-6 col-md-6">
							<div class="form-group">
						...
						<div class="col-lg-6 col-md-6">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="primary_contact_person_designation" />
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="primary_contact_person_name" />
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6">
							<div class="form-group">
								<label>Primary Contact Person Number</label>
								<input class="form-control" type="number" name="primary_contact_person_number" />
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6">
							<div class="form-group">
								...
								<input class="form-control" type="email" name="primary_contact_person_email" />
							</div>
						</div>
