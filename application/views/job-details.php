...
<head>
  <!-- meta tag -->
  <meta charset="utf-8" />
  <title>GetMeDesk - Job Details</title>
            ...
            <div class="row-table">
              <div class="col-cell">
                <div class="header-logo">
                  <div class="logo-area">
                    <a href="index.html">
                      <img class="normal-logo" src="<?php echo base_url('assets') ?>/images/logo-dark2.png" alt="logo" />
              ...
              <div class="col-cell rightbar-menu">
                <div class="expand-btn-inner">
                  ...
                  <div class="toolbar-sl-share">
                    <ul>
                      <li>
                        <a href="https://www.linkedin.com/company/getmedesk/?viewAsMember=true"><i class="fa fa-linkedin"></i></a>
                      </li>
                    </ul>
                  </div>
                </div>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-12 col-sm-12 md-mb-10">
            ...
            <ul class="footer-social md-mb-30">
              <li>
                <a href="https://www.linkedin.com/company/getmedesk/?viewAsMember=true" target="_blank"><span><i class="fa fa-linkedin"></i></span></a>
              </li>
            </ul>
          </div>
