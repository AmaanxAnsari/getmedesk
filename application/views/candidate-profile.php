...
<html lang="zxx">
	<head>
		<!-- meta tag -->
		<meta charset="utf-8" />
		<title>GetMeDesk - Candidate Profile</title>
	...
	<body class="home-blue-color">
      ...
      <div id="loader" class="loader">
		...
		<section class="candidate-profile-container ptb-100">
				...
				<div class="row">
					<div class="col-lg-4">
						<div class="card candidate-sidebar">
							...
							<ul>
								<li>
									<a href="<?php echo base_url('candidate_dashboard') ?>" 
										>Dashboard</a
									>
								</li>
								<li>
									<a href="<?php echo base_url('candidate_profile') ?>"class="active">Profile</a>
								</li>
								<li>
