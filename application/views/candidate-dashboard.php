...
<html lang="zxx">
	<head>
		<!-- meta tag -->
		<meta charset="utf-8" />
		<title>GetMeDesk - Candidate Dashboard</title>
		...
		<script
			async
			src="https://www.googletagmanager.com/gtag/js?id=G-G7D54H61N3"
		></script>
		<script>
	...
	<body class="home-blue-color">
      ...
      <div id="loader" class="loader">
										...
										<ul class="rs-address-area">
											...
											<li class="address-list">
												...
												<div class="info-content">
													...
													<div class="info-des">
														<a href="mailto:info@getmedesk.com"
															>info@getmedesk.com</a
														>
													</div>
												</div>
											</li>
									...
									<div class="expand-btn-inner">
										...
										<div class="toolbar-sl-share">
											<ul>
												<li>
													<a
														href="https://www.linkedin.com/company/getmedesk/?viewAsMember=true"
		...
		<section class="candidate-dashboard-container ptb-100">
			<div class="container" style="max-width: 1172px">
				<div class="row">
					<div class="col-lg-4">
						<div class="card candidate-sidebar">
							<h3>Share This Job</h3>
							<div class="candidate-img">
								<img
									src="https://templates.envytheme.com/jubi/default/assets/images/avatar-img.jpg"
									alt="Image"
								/>
							...
							<ul>
								<li>
									<a href="<?php echo base_url('candidate_dashboard') ?>"  class="active"
										>Dashboard</a
									>
								</li>
								<li>
									<a href="<?php echo base_url('candidate_profile') ?>">Profile</a>
								</li>
								<li>
									<a href="<?php echo base_url('applied_jobs') ?>">Applied Jobs</a>
								</li>
								<!-- <li>
					...
					<div class="col-lg-8">
						<div class="card candidate-dashboard">
							...
							<nav class="right_menu_togle hidden-md">
								...
								<div class="offcanvas-text">
									<p>
										...
										who are so beguiled and to demo realized, that they data
										forest see best business consulting wordpress theme 2021.
									</p>
								</div>
								<div class="media-img">
									<img src="assets/images/off2.jpg" alt="Images" />
							...
							<div class="col-lg-4">
								<div class="card candidate-sidebar">
									...
									<ul>
										...
										<li>
											<a href="candidate-profile.html">Profile</a>
										</li>
										<li>
				...
				<footer id="rs-footer" class="rs-footer style1 footer-home3-style">
							...
							<div class="row">
								<div class="col-lg-3 col-md-12 col-sm-12 md-mb-10">
									...
									<div class="textwidget white-color pb-40">
										<p>
											GetMeDesk is one of the leading human resources and
											recruitment services company based out of Pune. We
											specialize in IT recruitments.
										</p>
									</div>
									<ul class="footer-social md-mb-30">
										<li>
								...
								<div
									class="col-lg-3 col-md-12 col-sm-12 md-mb-10 pl-55 md-pl-15"
								>
									<h3 class="footer-title">Our Services</h3>
									<ul class="site-map">
										<li>
											<a href="business-planning.html">Permanent Hiring</a>
										</li>
										<li><a href="tax-strategy.html">Contractual Hiring</a></li>
										<li>
											<a href="financial-advices.html">Temporary Hiring</a>
										</li>
										<li>
											<a href="insurance-strategy.html">Bulk Recruitement</a>
										</li>
										<li>
											<a href="manage-investment.html">Execuitive Search</a>
										</li>
									</ul>
								</div>
								<div class="col-lg-3 col-md-12 col-sm-12 md-mb-10">
					...
					<div class="footer-bottom">
						<div class="container">
							<div class="row y-middle">
								<div
									class="col-lg-6 md-mb-10 text-lg-end text-center order-last"
								>
									<ul class="copy-right-menu">
										<li><a href="#rs-header">Home</a></li>
										<li><a href="#rs-about">About</a></li>
								...
								<div class="col-lg-6">
									<div class="copyright text-lg-start text-center">
										<p>
											© 2022 GetMeDesk - A part of ScaleFull Technologies LLP.
											All Rights Reserved.
										</p>
									</div>
								</div>
